      ...
      <section class="content">
        ...
        <div class="box box-info" id="">
          <div class="box-header with-border">
            <!-- filter -->
            <h4 class="no-margin">Filter Siswa</h4>
            <br>
            <div class="row">
              <div class="col-md-12">
                <div class="row">
              ...
              <table id="tabel" class="table table-bordered table-hover">
                ...
                <tbody>
                  <!-- <tr>
                    ...
                    <td>Aktif</td>
                    <td>
                      <button type="button" onclick="window.location.href='mn-riwayat-pembayaran.html';" value=""
                        class="btn btn-info btn-xs"><i class="fa fa-clock-o"></i>
                        Riyawat</button></td>
                    </td>
                    </td>
                  </tr> -->
...
<script>
    ...
    $(function () {
      ...
      var table = $("#tabel").DataTable({
            ...
            serverSide: true,
            ajax: {
                "url": "<?php echo base_url() . 'Histori/getSiswa' ?>",
                "type": "POST",
                 "data": function(data) {
      ...
      $('#tabel tbody').on('click', '.edit', function() {
            ...
            window.location.href = '<?php echo base_url(); ?>Histori/datail?param=' + nis ;
      });
