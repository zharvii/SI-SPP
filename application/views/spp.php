<!-- Content Wrapper. Contains page content -->
    <div class="content-wrapper">
      ...
      <!-- Main content Master SPP -->
      <section class="content">

        <!-- From spp -->
        <form id="frmSpp" onsubmit="return false;">
                ...
                <div class="col-md-12">
                  ...
                  <div class="row">
                    <div class="form-group col-md-6">
                      <label for="txt_namaPegawai">Tahun</label>
                      <input type="number" class="form-control" id="tahun" name="tahun">
                    </div>
                    <div class="form-group col-md-6">
                      <label for="txt_namaPegawai">Nominal</label>
        ...
        <div class="box box-info">
          <div class="box-header with-border">
            <h3 class="box-title">Daftar Spp</h3>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
            <div class="table-responsive">
              <table id="tspp" class="table table-bordered table-hover">
                <thead>
                  <tr>
                    <th>ID</th>
                    <th>Tahun</th>
                ...
                <tbody>
                  <!-- <tr>
                    ...
                    <td>Aktif</td>
                    <td>
                      <button type="button" class="btn btn-warning btn-xs" id="">edit</button>
                    </td>
                  </tr>
                  <tr>
                    <td>5678</td>
    ...
    $(function () {
      ...
      function validasi(){
        if($('#tahun').val()=='' || $('#tahun').val()==null){
          ...
          if($('#nominal').val()=='' || $('#nominal').val()==null){
      ...
      var table = $("#tspp").dataTable({
            ...
            serverSide: true,
            ajax: {
                "url": "<?php echo base_url() . 'spp/getSpp' ?>",
                "type": "POST"
            },
            columns: [{
                    "data": "id_spp"
      ...
      $('#batal').click(function(){
        $('#frmSpp').trigger("reset")
        mode='save'
      });

      $('#tspp').on('click', '.edit', function() {
            let id = $(this).data('id')
      ...
      $('#tspp').on('click', '.hapus', function() {
           if(confirm('Hapus Data?')){
             var id = $(this).data('id');

              $.ajax({
                url: "<?php echo base_url(); ?>spp/hapusSpp/"+id,
                method: "Get",
